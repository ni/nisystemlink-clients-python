...
#         ):
#             create_table(df=frame, table_name="TestTable1", nullable_columns=True)
...
#         id = create_table(
#             df=sample_dataframe, table_name="TestTable2", nullable_columns=False
#         )
...
#     def test__append_pandas_df_to_table_with_invalid_data__raises(
