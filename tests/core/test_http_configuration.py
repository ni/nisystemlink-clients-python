...
class TestHttpConfiguration:
    ...
    def test__valid_server_uri__initializes_correctly(self):
        ...
        assert config.timeout_milliseconds == HttpConfiguration.DEFAULT_TIMEOUT_MILLISECONDS
    ...
    def test__username_without_password__raises_value_error(self):
        ...
        with pytest.raises(ValueError, match="If username or password is set, both must be set"):
    ...
    def test__username_property__is_read_only(self):
        ...
        config = HttpConfiguration("https://example.com", username="test", password="test")
