...
class CreateSpecificationsRequest(JsonModel):
    ...
    specs: Optional[List[CreateSpecificationRequestObject]]
...
class CreateSpecificationsPartialSuccessResponse(JsonModel):
    ...
    created_specs: Optional[List[CreateSpecificationResponseObject]]
    """Information about the created specification(s)"""

    failed_specs: Optional[List[CreateSpecificationRequestObject]]
