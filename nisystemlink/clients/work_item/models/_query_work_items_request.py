...
class WorkItemField(str, Enum):
    ...
    RESOURCES_SYSTEMS_SELECTIONS_TARGET_LOCATION_ID = "RESOURCES_SYSTEMS_SELECTIONS_TARGET_LOCATION_ID"
    RESOURCES_ASSETS_SELECTIONS = "RESOURCES_ASSETS_SELECTIONS"
    RESOURCES_ASSETS_SELECTIONS_ID = "RESOURCES_ASSETS_SELECTIONS_ID"
    RESOURCES_ASSETS_SELECTIONS_TARGET_LOCATION_ID = "RESOURCES_ASSETS_SELECTIONS_TARGET_LOCATION_ID"
    ...
    RESOURCES_DUTS_SELECTIONS_TARGET_LOCATION_ID = "RESOURCES_DUTS_SELECTIONS_TARGET_LOCATION_ID"
    ...
    RESOURCES_FIXTURES_SELECTIONS_TARGET_LOCATION_ID = "RESOURCES_FIXTURES_SELECTIONS_TARGET_LOCATION_ID"
